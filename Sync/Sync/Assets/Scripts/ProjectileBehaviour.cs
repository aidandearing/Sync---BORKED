...
public class ProjectileBehaviour : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ((Synchronism)Blackboard.Global["Synchroniser"].Value).synchronisers[interval].RegisterCallback(this, Delegate_OnTime);
    }
    ...
    void Destroy()
    {
        ...
        ((Synchronism)Blackboard.Global["Synchroniser"].Value).synchronisers[interval].UnregisterCallback(this);

...
public class BeamToOrb : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Synchronism.Instance.synchronisers[ListenTo].RegisterCallback(this, SetColours);
    }
    ...
    void Update()
    {
        ...
        currentHSV = Vector3.Lerp(startHSV, endHSV, Synchronism.Instance.synchronisers[ListenTo].Percent);
